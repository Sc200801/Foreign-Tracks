document.addEventListener('DOMContentLoaded', () => {
    ...
    if (socket) {
        ...
        socket.on('room:game_started', (data) => {
            // Se guarda para que game.js pueda leerlo cuando arranque
            // la escena del Hotel: este evento llega ANTES de que esa
            // escena exista (recién se navega a selección de escena
            // aquí), así que un listener registrado después ya no lo
            // vería si no quedara cacheado.
            window.__ultimoJuegoIniciado = data;
